...
public class Layout implements Cloneable, Serializable
{
    ...
    public Layout(double[][] coordinate)
    {
        ...
        this.coordinate[0] = (double[])coordinate[0].clone();
        this.coordinate[1] = (double[])coordinate[1].clone();
    }
    ...
    public Object clone()
    {
        ...
        try
        {
            ...
            clonedLayout.coordinate = getCoordinates();
            return clonedLayout;
        }
    ...
    public double[][] getCoordinates()
    {
        ...
        clonedCoordinate[0] = (double[])coordinate[0].clone();
        clonedCoordinate[1] = (double[])coordinate[1].clone();
